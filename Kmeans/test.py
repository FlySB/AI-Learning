...
def kMeans(dataMat, k, centroids,distMeas=distEclud):
    '''
...
def clusterClubs(fileName, imgName, centroids,numClust=5):
    '''
    ...
    myCentroids, clustAssing = kMeans(datMat,numClust,centroids)
